...
export default function DateTimePickerShowcaseExample() {
  ...
  return (
    <div className="w-full max-w-4xl space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Natural Language DateTime Showcase
          </CardTitle>
          <CardDescription>
            Explore the power of natural language date parsing with different use cases
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Try These Natural Language Examples</CardTitle>
          <CardDescription>
      ...
      {parseHistory.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Recent Parsing History</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="space-y-3">
              {parseHistory.map((entry, index) => (
                <div key={entry.timestamp} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  <div>
